...
//std::string filename = "classifications.xml";
...
HOGDescriptor hog(
   ...
   // cv::Mat grayImage;
    ...
    //         validContoursWithData.emplace_back(allContoursWithData[i]);            // if so, append to valid contour list
    //     }
    // }
...
//      deskewedTestCells1.emplace_back(deskewedImg);  }  
...
//  for(int y=0;y<testCells.size();y++){
...
//  ut image with our processing results to the host over USB:
...
//     std::vector<HelloJeVois::ContourWithData> allContoursWithData;           // declare empty vectors,
//     std::vector<HelloJeVois::ContourWithData> validContoursWithData;         // we will fill these shortly
//     std::vector<HelloJeVois::ContourWithData> allContoursWithData1;           // declare empty vectors,
//     std::vector<HelloJeVois::ContourWithData> validContoursWithData1;         // we will fill these shortly
//     std::vector<HelloJeVois::ContourWithData> allContoursWithData2;           // declare empty vectors,
//     std::vector<HelloJeVois::ContourWithData> validContoursWithData2;         // we will fill these shortly
...
//     HelloJeVois::ContourWithData contourWithData1;
...
//     HelloJeVois::ContourWithData contourWithData2;
...
//     std::sort(validContoursWithData.begin(), validContoursWithData.end(), HelloJeVois::ContourWithData::sortByBoundingRectXPosition);
//      std::sort(validContoursWithData1.begin(), validContoursWithData1.end(), HelloJeVois::ContourWithData::sortByBoundingRectXPosition1);
//         std::sort(validContoursWithData2.begin(), validContoursWithData2.end(), HelloJeVois::ContourWithData::sortByBoundingRectXPosition2);
